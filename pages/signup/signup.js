...
Page({
  ...
  data: {
    ...
    checked: false,
    items: [
      { value: "月2回套餐", name: "月2回套餐" },
      { value: "月4回套餐", name: "月4回套餐", checked: "true" },
      { value: "月6回套餐", name: "月6回套餐" },
      { value: "月8回套餐", name: "月8回套餐" },
      { value: "ZERO放题", name: "ZERO放题" },
      { value: "平日放题", name: "平日放题" },
      { value: "土日套餐", name: "土日套餐" },
      { value: "放题套餐", name: "放题套餐" },
    ],
  },
